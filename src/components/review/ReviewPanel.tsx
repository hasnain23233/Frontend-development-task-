    ...
    <div className=' rounded-2xl bg-[#EDF4FF] p-3 w-full  sm:p-4'>
      ...
      <div className='mt-4 rounded-xl  p-4'>
        <div className='flex items-center gap-3 justify-between'>
          <img src='src\assets\bage.png' alt='budget' />
          <div className='flex flex-col items-end gap-1 justify-end'>
            <div className='flex justify-between text-center bg-[#4E2FD2] p-1 w-40 rounded-xl text-sm '>
              <span className='text-white w-full text-center'>as low as {formatCurrency(monthlyFinancingEstimate)}/mo</span>
            </div>
            <div className='mt-1 flex flex-wrap items-baseline text-end gap-2'>
              <span className='text-gray-400  line-through'>{formatCurrency(originalTotal)}</span>
              <span className='text-xl font-bold text-[#4E2FD2] sm:text-3xl'>{formatCurrency(total)}</span>
            </div>
          </div>
        </div>
